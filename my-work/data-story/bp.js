...
d3.csv('datasets/Blackpink_videos.csv').then(function(data){
  ...
  one.html('<p>Among the top 50 most-viewed videos, the highest like/dislike ratio is <strong style="font-size: 32px;">' + d3.max(ratio) +' </strong>; the lowest one is <strong style="font-size: 32px;">' + d3.min(ratio) +'</strong>, which is the lowest among these four groups. </br> The average ratio is <strong style="font-size: 32px;">' + formatDecimal(d3.mean(decimals)) +'</strong>.</p>');

  let two = d3.select("#two").append("div");

  two.html('<p>The Category <strong style="font-size: 32px;">"Music"</strong> is used most frequently. </br><strong style="font-size: 32px;">"Military" </strong>and <strong style="font-size: 32px;">"Reggae" </strong>are unique to this group.</p>');
