...
d3.csv('datasets/BTS_videos.csv').then(function(data){
  ...
  zero.html('<p>For BTS, among the top 50 most-viewed videos on Youtube, the highest one has <strong style="font-size: 32px;">' + data[0].viewCount +' </strong>views; the <style="color: #d9ab48">lowest one has <strong style="font-size: 32px;">' + data[49].viewCount +'</strong> views.</p>');
  ...
  two.html('<p>The Category <strong style="font-size: 32px;">"Music"</strong> is used most frequently. </br><strong style="font-size: 32px;">"Society" </strong>is unique to this group.</p>');
